  ...
  return (
    ...
    >
      <div style={{ width: "100%", height: "240px", overflow: "hidden", position: "relative", background: "#111", borderBottom: "1px solid rgba(40,40,40,0.6)" }}>
        <div role="presentation" aria-hidden="true" style={{ position: "absolute", top: 0, left: 0, right: 0, height: "28px", background: "rgba(20,20,20,0.95)", display: "flex", alignItems: "center", gap: "5px", padding: "0 10px", zIndex: 2, borderBottom: "1px solid rgba(40,40,40,0.5)" }}>
        ...
        <div style={{ position: "absolute", top: "28px", left: 0, width: "200%", height: "424px", transform: "scale(0.5)", transformOrigin: "top left", pointerEvents: "none" }}>
          <iframe
            src={previewUrl}
            title={`Live preview of ${template.title} template`}
  ...
  return (
    <div style={{ width: "100%", maxWidth: "680px", margin: "0 auto" }}>
      ...
      >
        ...
        <label htmlFor="bottom-prompt-input" className="sr-only">Describe the app you want to build</label>
        <textarea
      ...
      <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "8px", marginTop: "14px" }} role="list" aria-label="Example prompts">
        {examples.map((p, i) => (
          <button
            key={i}
            role="listitem"
...
function StructuredData() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "WebSite",
        "name": "The Hustler Bot",
        "url": "https://thehustlerbot.com",
        "description": "AI-powered app builder. Describe any app in plain English and watch it get built live in seconds — no coding required.",
        "potentialAction": {
          "@type": "SearchAction",
          "target": "https://thehustlerbot.com/studio?prompt={search_term_string}",
      ...
      },
      {
        ...
        "operatingSystem": "Web",
        "url": "https://thehustlerbot.com",
        "description": "Build any web app by describing it in plain English. The AI agent writes code, builds live, and shows a working preview in seconds.",
        "offers": {
          "@type": "Offer",
          "price": "0",
          "priceCurrency": "USD"
      ...
      {
        "@type": "HowTo",
        "name": "How to build an app with The Hustler Bot",
        "step": [
          { "@type": "HowToStep", "position": 1, "name": "Describe Your App", "text": "Type what you want to build in plain English." },
          { "@type": "HowToStep", "position": 2, "name": "Agent Builds in Real Time", "text": "Watch the agent write components, styling, and logic live." },
          { "@type": "HowToStep", "position": 3, "name": "Interact & Iterate", "text": "Click around your app and ask for changes in the chat." },
          { "@type": "HowToStep", "position": 4, "name": "Download & Deploy", "text": "Export your code as a clean React project and deploy instantly." }
        ]
      }
    ]
  };
...
function LandingPage() {
  ...
  const pageTitle       = "The Hustler Bot — Build Any App, Just Describe It";
  const pageDescription = "The Hustler Bot is an AI-powered app builder. Type what you want to build in plain English and the agent writes the code, builds it live, and shows you a working preview — in seconds. No coding required.";
  const pageUrl         = "https://thehustlerbot.com";
  const ogImage         = "https://thehustlerbot.com/og-image.png"; // replace with your real OG image
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="keywords" content="AI app builder, no-code, build apps with AI, React app generator, SaaS builder, website builder AI" />
        ...
        <meta property="og:site_name"   content="The Hustler Bot" />
      ...
      <div style={{ paddingTop: "72px" }} className="bg-black text-white font-sans overflow-x-hidden">
        ...
        {/* ── HERO ── */}
        <section
          aria-label="Hero — Build any app with AI"
        ...
        >
          <motion.div className="absolute top-0 left-0 w-full h-full bg-gradient-radial from-red-900/30 via-transparent to-black pointer-events-none z-0" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 2 }} aria-hidden="true" />
          ...
          >
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
              ...
              <span aria-hidden="true" style={{ width: "8px", height: "8px", borderRadius: "50%", background: "#ff3333", display: "inline-block", boxShadow: "0 0 6px #ff3333,0 0 12px #ff3333", animation: "badgePulse 1.5s ease-in-out infinite" }} />
            ...
            <div className="hero-glow-block" style={{ marginBottom: "32px" }}>
              ...
              <p className="text-base text-gray-400 max-w-lg mx-auto">
                Type what you want and the agent writes the code, builds it live, and shows you a working preview — in seconds. No coding required.
              </p>
            </div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, duration: 0.8 }} style={{ width: "100%", marginBottom: "16px" }}>
              <div className="prompt-wrap" style={{ background: "rgba(8,2,2,0.92)", border: "1px solid rgba(120,0,0,0.5)", borderRadius: "20px", backdropFilter: "blur(20px)", boxShadow: "0 4px 40px rgba(100,0,0,0.2),inset 0 1px 0 rgba(255,255,255,0.04)", overflow: "hidden" }}>
                <label htmlFor="hero-prompt-input" className="sr-only">Describe the app you want to build</label>
                <textarea
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 14px 14px" }}>
                  ...
                  <button
                    ...
                    onClick={() => handleSend()}
                    disabled={!prompt.trim()}
                    aria-label="Build your described app"
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }} style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "8px" }} role="list" aria-label="Example app ideas">
              {examplePrompts.map((p, i) => (
                <button key={i} role="listitem" className="example-btn" onClick={() => { setPrompt(p); textareaRef.current?.focus(); }}
            ...
            {isLoggedIn && (
              ...
              >
                <button
                  ...
                  aria-label="Open your app building dashboard"
          ...
          <div aria-hidden="true" style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -65%)", width: "700px", height: "700px", zIndex: 1, opacity: 0.9, pointerEvents: "none" }}>
            <HeroBot style={{ width: "100%", height: "100%" }} />
          </div>
        </section>

        {/* ── TEMPLATES ── */}
        <section aria-labelledby="templates-heading" className="py-36 bg-black text-white px-4 md:px-12 z-10 relative">
          <motion.div className="text-center mb-20" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}>
            <h2 id="templates-heading" className="text-5xl md:text-6xl font-bold mb-5" style={{ textShadow: "0 0 30px rgba(255,26,26,0.3)" }}>Start from a Template</h2>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-8" role="list" aria-label="Available app templates">
            ...
            <div style={{ position: "relative" }}>
              ...
              <div style={{
                ...
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  aria-label="Browse all app templates"
                ...
                >
                  ...
                  <span className="template-arrow" aria-hidden="true" style={{ fontSize: "1.2rem", color: "rgba(220,60,60,0.8)" }}>↓</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* ── HOW IT WORKS ── */}
        <section aria-labelledby="how-it-works-heading" className="py-36 bg-black relative z-10 overflow-hidden px-4 md:px-12">
          <motion.h2
            id="how-it-works-heading"
            className="text-5xl md:text-6xl font-bold text-center mb-24 text-white"
          ...
          <div className="relative max-w-6xl mx-auto">
            <div aria-hidden="true" className="absolute left-1/2 top-0 h-full w-[3px] bg-gradient-to-b from-red-600 via-transparent to-black animate-pulse z-0 transform -translate-x-1/2" />
            <ol style={{ listStyle: "none", padding: 0, margin: 0 }}>
              {roadmapSteps.map((item, index) => (
                <motion.li key={index} initial={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: index * 0.2 }}
                  ...
                  <div aria-hidden="true" className="absolute top-0 left-1/2 transform -translate-x-1/2 flex flex-col items-center z-10">
        ...
        {/* ── BOTTOM CTA ── */}
        <section aria-labelledby="cta-heading" className="relative py-36 bg-gradient-to-b from-black via-[#110000] to-black overflow-hidden z-20 px-4">
          <motion.div aria-hidden="true" className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[200%] h-full bg-gradient-radial from-red-800/30 to-transparent blur-2xl opacity-60 pointer-events-none" initial={{ scale: 0.7, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} transition={{ duration: 1.5 }} />
          <motion.h2
            id="cta-heading"
            initial={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}
            className="text-4xl md:text-5xl font-bold text-white text-center z-10 relative mb-4"
            style={{ textShadow: "0 0 30px rgba(255,26,26,0.3)" }}
          >
      ...
      <div
        role="button"
        tabIndex={0}
        aria-label={isLoggedIn ? "Open your dashboard" : "Start building your app"}
      ...
      >
        <div aria-hidden="true" className="w-12 h-12 rounded-full overflow-hidden flex-shrink-0">
