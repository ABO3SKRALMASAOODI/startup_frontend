...
function LandingPage() {
  ...
  const { rive: heroRive,   RiveComponent: HeroBot   } = useRive({ src: "/hustler-robot107.riv",      autoplay: true, stateMachines: ["State Machine 1"] });
  const { rive: bubbleRive, RiveComponent: BubbleBot } = useRive({ src: "/hustler-robot108.riv", autoplay: true, stateMachines: ["State Machine 1"] });
